...
priority_queue< vector<char>, vector< vector<char> >, MyComparison > PowerSet( vector<char> v );
...
int main() {
    ...
    priority_queue< vector<char>, vector< vector<char> >, MyComparison > power = PowerSet(p);
